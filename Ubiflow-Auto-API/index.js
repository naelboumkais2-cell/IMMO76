...
INTERDICTION ÉTENDUE (au-delà de la liste ci-dessus) : n'utilise JAMAIS les mots "sécurisé", "sécurisée", "sécuriser" ou "sécurité" pour qualifier l'investissement, le placement, les revenus locatifs ou la rentabilité — même en dehors des formulations strictes listées ci-dessus, l'idée même de "sécurité" appliquée à un placement financier suggère une garantie que ce cadre réglementé interdit d'affirmer. Utilise à la place des formulations factuelles sur le mécanisme (bail commercial, loyer versé par l'exploitant) plutôt qu'un qualificatif de sécurité. "Sécurisé"/"sécurité" restent acceptables uniquement pour un sens sans rapport avec l'investissement (ex: sécurité du bâtiment, digicode) — jamais pour qualifier le placement ou les revenus.
